...
<template>
    <div v-motion-pop-visible>
        ...
        <div :id="'accordion-collapse-body-' + props.number" class="hidden" :aria-labelledby="'accordion-collapse-heading-' + props.number">
            <div class="p-5 ">
                <p class="mb-2 text-gray-500 dark:text-gray-400">{{ props.text }}</p>            
            </div>
        </div>
    </div>
</template>